package com.ljz.base.rxbus;

import com.ljz.base.rxbus.annotation.Tag;
import com.ljz.base.rxbus.entity.DeadEvent;
...
import com.ljz.base.rxbus.finder.Finder;
 ...
 *
 * @author HwangJR  https://github.com/AndroidKnife/RxBus/tree/2.x
 * @version 2.0.0-beta
 */
public class Bus {
     ...
     */
    private void dispatch(Object event, SubscriberEvent wrapper) {
        if (wrapper.isValid()) {
     ...
     */
    private ProducerEvent getProducerForEventType(EventType type) {
     ...
     */
    private Set<SubscriberEvent> getSubscribersForEventType(EventType type) {
