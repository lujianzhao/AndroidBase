...
import com.lujianzhao.base.adapter.recyclerview.listener.OnItemDragListener;
import com.lujianzhao.base.adapter.recyclerview.listener.OnItemSwipeListener;
    ...
    public void onBindViewHolder(K holder, int positions) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(com.lujianzhao.base.R.id.BaseQuickAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(com.lujianzhao.base.R.id.BaseQuickAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(com.lujianzhao.base.R.id.BaseQuickAdapter_viewholder_support));
                    }
                    return true;
                }
            };
