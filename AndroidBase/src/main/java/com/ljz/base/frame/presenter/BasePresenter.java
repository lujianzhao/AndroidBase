package com.ljz.base.frame.presenter;
...
public class BasePresenter<M extends BaseModel, V extends IBaseView> implements PresenterWithModel<M> {
    ...
    /**
     * Presenter开始工作
     * 在{@link com.ljz.base.frame.fragment.impl.BaseMvpFragment#initData()},
     * {@link com.ljz.base.frame.activity.impl.BaseMvpActivity#initData()} 调用
     */
