...
import com.android.base.adapter.listview.QuickAdapter;
...
public class BaseRcvAdapterHelper extends RecyclerView.ViewHolder {
    ...
    public BaseRcvAdapterHelper setListView(int viewId, QuickAdapter<?> adapter) {
        ListView view = retrieveView(viewId);
