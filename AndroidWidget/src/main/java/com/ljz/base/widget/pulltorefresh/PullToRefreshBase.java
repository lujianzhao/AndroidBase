 ...
 *******************************************************************************/
package com.ljz.base.widget.pulltorefresh;
...
import com.ljz.base.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.ljz.base.widget.pulltorefresh.internal.LoadingLayout;
import com.ljz.base.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.ljz.base.widget.pulltorefresh.internal.Utils;
import com.ljz.base.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Styleables from XML
		TypedArray a = context.obtainStyledAttributes(attrs, com.ljz.base.widget.R.styleable.PullToRefresh);

		if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrMode)) {
			mMode = Mode.mapIntToValue(a.getInteger(com.ljz.base.widget.R.styleable.PullToRefresh_ptrMode, 0));
		}

		if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrAnimationStyle)) {
			mLoadingAnimationStyle = AnimationStyle.mapIntToValue(a.getInteger(
					com.ljz.base.widget.R.styleable.PullToRefresh_ptrAnimationStyle, 0));
		}
		 ...
		 * Styleables from XML
		 */
		if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			Drawable background = a.getDrawable(com.ljz.base.widget.R.styleable.PullToRefresh_ptrRefreshableViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		} else if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrAdapterViewBackground)) {
			Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
			Drawable background = a.getDrawable(com.ljz.base.widget.R.styleable.PullToRefresh_ptrAdapterViewBackground);
			if (null != background) {
				mRefreshableView.setBackgroundDrawable(background);
			}
		}

		if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrOverScroll)) {
			mOverScrollEnabled = a.getBoolean(com.ljz.base.widget.R.styleable.PullToRefresh_ptrOverScroll, true);
		}

		if (a.hasValue(com.ljz.base.widget.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled)) {
			mScrollingWhileRefreshingEnabled = a.getBoolean(
					com.ljz.base.widget.R.styleable.PullToRefresh_ptrScrollingWhileRefreshingEnabled, false);
		}
