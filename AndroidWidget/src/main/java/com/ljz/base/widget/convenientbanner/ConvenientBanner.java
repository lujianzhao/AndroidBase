package com.ljz.base.widget.convenientbanner;
...
import com.ljz.base.widget.convenientbanner.adapter.CBPageAdapter;
import com.ljz.base.widget.convenientbanner.holder.CBViewHolderCreator;
import com.ljz.base.widget.convenientbanner.listener.CBPageChangeListener;
import com.ljz.base.widget.convenientbanner.listener.OnItemClickListener;
import com.ljz.base.widget.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private com.ljz.base.widget.convenientbanner.ViewPagerScroller scroller;
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, com.ljz.base.widget.R.styleable.ConvenientBanner);
        canLoop = a.getBoolean(com.ljz.base.widget.R.styleable.ConvenientBanner_canLoop, true);
        pointPadding =  a.getDimensionPixelSize(com.ljz.base.widget.R.styleable.ConvenientBanner_pointPadding, 5);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(com.ljz.base.widget.R.layout.include_viewpager, this, true);
        viewPager = (CBLoopViewPager) hView.findViewById(com.ljz.base.widget.R.id.cbLoopViewPager);
        loPageTurningPoint = (ViewGroup) hView.findViewById(com.ljz.base.widget.R.id.loPageTurningPoint);
        initViewPagerScroll();
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(pointPadding, 0, pointPadding, 0);
    ...
    private void initViewPagerScroll() {
        try {
            ...
            scroller = new com.ljz.base.widget.convenientbanner.ViewPagerScroller(viewPager.getContext());
