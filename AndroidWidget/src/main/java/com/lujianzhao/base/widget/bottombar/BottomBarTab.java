package com.lujianzhao.base.widget.bottombar;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, String title, int textColor) {
        LayoutInflater.from(context).inflate(com.lujianzhao.base.widget.R.layout.tab_indicator, this);
        TextView  textView = (TextView) findViewById(com.lujianzhao.base.widget.R.id.tab_title);
        ImageView imageView = (ImageView) findViewById(com.lujianzhao.base.widget.R.id.tab_icon);
