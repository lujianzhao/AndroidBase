package com.lujianzhao.base.widget.convenientbanner;
...
import com.lujianzhao.base.widget.convenientbanner.adapter.CBPageAdapter;
import com.lujianzhao.base.widget.convenientbanner.holder.CBViewHolderCreator;
import com.lujianzhao.base.widget.convenientbanner.listener.CBPageChangeListener;
import com.lujianzhao.base.widget.convenientbanner.listener.OnItemClickListener;
import com.lujianzhao.base.widget.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, com.lujianzhao.base.widget.R.styleable.ConvenientBanner);
        canLoop = a.getBoolean(com.lujianzhao.base.widget.R.styleable.ConvenientBanner_canLoop, true);
        pointPadding =  a.getDimensionPixelSize(com.lujianzhao.base.widget.R.styleable.ConvenientBanner_pointPadding, 5);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(com.lujianzhao.base.widget.R.layout.include_viewpager, this, true);
        viewPager = (CBLoopViewPager) hView.findViewById(com.lujianzhao.base.widget.R.id.cbLoopViewPager);
        loPageTurningPoint = (ViewGroup) hView.findViewById(com.lujianzhao.base.widget.R.id.loPageTurningPoint);
        initViewPagerScroll();
