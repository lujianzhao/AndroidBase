package com.lujianzhao.base.widget.recyclerview.decoration;
...
import com.lujianzhao.base.widget.recyclerview.FamiliarRecyclerView;
...
public class FamiliarDefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean isEmptyView(FamiliarRecyclerView familiarRecyclerView, int position, int headersCount) {
        if (null != familiarRecyclerView && familiarRecyclerView.isShowEmptyView() && position == headersCount) {
            return true;
        }
